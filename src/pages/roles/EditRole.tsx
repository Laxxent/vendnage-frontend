    ...
    return (
      <>
        ...
        <main className="flex flex-col gap-6 flex-1">
          <section className="flex flex-col gap-6 flex-1 rounded-3xl p-[18px] bg-white">
  ...
  return (
    <>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                title="Quick Guide to Edit Role"
              >
                <svg
                  width="20"
                  height="20"
      ...
      <SuccessNotification
        ...
        message="Data role telah berhasil diperbarui."
        itemName={updatedRoleName}
      />
        ...
        <div className="modal flex flex-1 items-center justify-center h-full fixed top-0 w-full z-50">
          ...
          <div className="relative flex flex-col w-[500px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white max-h-[90vh] overflow-y-auto">
            <div className="modal-header flex items-center justify-between">
              <p className="font-semibold text-xl">Quick Guide to Edit Role</p>
              <button
                onClick={() => setShowGuideModal(false)}
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-[6px]">
                  ...
                  <p className="font-medium leading-[140%]">
                    Clearly and accurately update role responsibilities to ensure accountability
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    For PIC roles, update which pages they can access to control their permissions
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Verify that no duplicate role names exist when changing the role name
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Ensure the role name remains clear, concise, and specific after changes
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Thoroughly review all changes before saving to ensure accuracy
                  </p>
                </li>
              </ul>
            </div>
