...
const AddBrand = () => {
  ...
  // Auto-hide toast after 1 second and navigate to list
  useEffect(() => {
    if (showToast) {
      ...
      >
        <div className="flex items-center gap-6 h-[92px] bg-white w-full rounded-3xl p-[18px]">
          <div className="flex flex-col gap-[6px] w-full">
            <h1 className="font-bold text-2xl">Add New Brand</h1>
            <Link
              to={"/brands"}
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                title="Quick Guide to Add New Brand"
              >
                <svg
                  width="20"
                  height="20"
        ...
        <div className="modal flex flex-1 items-center justify-center h-full fixed top-0 w-full z-50">
          ...
          <div className="relative flex flex-col w-[500px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white max-h-[90vh] overflow-y-auto">
            <div className="modal-header flex items-center justify-between">
              <p className="font-semibold text-xl">Quick Guide to Add New Brand</p>
              <button
                onClick={() => setShowGuideModal(false)}
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-[6px]">
                  ...
                  <p className="font-medium leading-[140%]">
                    Ensure the brand name is relevant, clear, and easy to understand
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Verify the brand image is appropriate and high-quality
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Choose a user-friendly and clear tagline that represents the brand
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Check for duplicate brand names to avoid redundancy
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
