import { useCreateVendingMachine } from "../../hooks/useVendingMachines";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { VendingMachineFormData, vendingMachineSchema } from "../../schemas/vendingMachineSchema";
...
const AddVendingMachine = () => {
  ...
  const { mutate: createVendingMachine, isPending } = useCreateVendingMachine();
  ...
  const {
    ...
    setError,
    formState: { errors },
  } = useForm<VendingMachineFormData>({
    resolver: zodResolver(vendingMachineSchema),
    defaultValues: {
      name: "",
      location: "",
      status: "active",
  ...
  // Auto-hide toast after 6 seconds and navigate to list
  useEffect(() => {
    if (showToast) {
      const timer = setTimeout(() => {
        setShowToast(false);
        // Navigate after toast is hidden
        setTimeout(() => {
  ...
  const onSubmit = (data: VendingMachineFormData) => {
        ...
        if (error.response) {
          ...
          if (errors) {
            Object.entries(errors).forEach(([key, messages]) => {
              setError(key as keyof VendingMachineFormData, {
                type: "server",
                message: messages[0],
              });
            });
            ...
            >
              ...
              <div className="text-center mb-3" style={{ padding: "0 2px" }}>
                ...
                <p className="text-xs text-gray-600 leading-snug">
                  Vending machine has been successfully created.
                </p>
              </div>
      ...
      >
          <div className="flex items-center gap-6 h-[92px] bg-white w-full rounded-3xl p-[18px]">
            <div className="flex flex-col gap-[6px] w-full">
              <h1 className="font-bold text-2xl">Add New Vending Machine</h1>
              <Link
                to={"/vending-machines"}
            ...
            >
              ...
              <h2 className="font-semibold text-xl capitalize">
                ...
                <button
                  ...
                  title="Quick Guide to Add New Vending Machine"
                >
                  <svg
                    width="20"
                    height="20"
              ...
              <div className="flex items-center justify-end gap-4">
                ...
                <button type="submit" className="btn btn-primary font-semibold" disabled={isPending}>
                  {isPending ? "Saving..." : "Save Vending Machine"}
                </button>
              </div>
            </form>
          </section>
        ...
        <div className="modal flex flex-1 items-center justify-center h-full fixed top-0 w-full z-50">
          ...
          <div className="relative flex flex-col w-[500px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white max-h-[90vh] overflow-y-auto">
            <div className="modal-header flex items-center justify-between">
              <p className="font-semibold text-xl">Quick Guide to Add New Vending Machine</p>
              <button
                onClick={() => setShowGuideModal(false)}
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-[6px]">
                  ...
                  <p className="font-medium leading-[140%]">
                    Enter a Clear and Descriptive Vending Machine Name
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Provide the Location Where the Vending Machine is Placed (Required)
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Assign a PIC to manage this vending machine (Required). You can select any PIC regardless of location (e.g., assign PIC Semarang to a Bandungan vending machine)
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Set the Status (Active, Inactive, or Maintenance) - Optional
                  </p>
                </li>
                <li className="flex gap-[6px]">
                  <img
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Review all information and click "Save Vending Machine" to create
                  </p>
                </li>
              </ul>
            </div>
